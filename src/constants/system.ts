...
const DEFAULT_PREFIX = `You are Claudex, a free open-source CLI for software engineering built by Lakshmikanthan K (letchu_pkt), based on Claude Code.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Claudex, a free open-source CLI for software engineering built by Lakshmikanthan K (letchu_pkt), based on Claude Code, running within the Claude Agent SDK.`
